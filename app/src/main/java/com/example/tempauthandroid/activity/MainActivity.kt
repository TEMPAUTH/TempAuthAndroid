...
//    private val requestToServer = RequestToServer
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        main_activity_bnv.setOnNavigationItemSelectedListener {
            when (it.itemId) {
                R.id.menu_auth_req -> supportFragmentManager.beginTransaction()
                    .replace(R.id.main_activity_fg, authReqFragment).commit()
                R.id.menu_auth_res -> supportFragmentManager.beginTransaction()
                    .replace(R.id.main_activity_fg, authResFragment).commit()
                R.id.menu_auth_use -> supportFragmentManager.beginTransaction()
                    .replace(R.id.main_activity_fg, authUseFragment).commit()
                R.id.menu_my_page -> supportFragmentManager.beginTransaction()
                    .replace(R.id.main_activity_fg, myPageFragment).commit()
            }
            true
        }
    }
